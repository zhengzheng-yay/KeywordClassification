...
speech_command_dir=$data_dir/speech_commands
audio_dir=$data_dir/speech_commands/audio
...
if [ $stage -le -1 ]; then
    ...
    python local/split_dataset.py $data_dir/speech_commands
fi
